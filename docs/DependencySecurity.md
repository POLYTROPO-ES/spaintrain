...
The independent [starter manifest](../fastenough/package.json) now requires Vite >=8.0.16 and Vitest/coverage-v8 >=4.1.11. Its new [lockfile](../fastenough/package-lock.json) resolves Vite 8.3.0 and matching Vitest/coverage-v8 4.1.11, and makes its full transitive audit reproducible. It does not depend on SpainTrain. No React or TypeScript source migration was performed.
...
| Vite | High / moderate | [GHSA-4w7w-66w2-5vf9](https://github.com/advisories/GHSA-4w7w-66w2-5vf9), [GHSA-p9ff-h696-f583](https://github.com/advisories/GHSA-p9ff-h696-f583), [GHSA-v6wh-96g9-6wx3](https://github.com/advisories/GHSA-v6wh-96g9-6wx3), [GHSA-fx2h-pf6j-xcff](https://github.com/advisories/GHSA-fx2h-pf6j-xcff): dev-server file access, Windows deny bypass and UNC credential disclosure; starter also [GHSA-v2wj-q39q-566r](https://github.com/advisories/GHSA-v2wj-q39q-566r) |
...
- Starter: ordinary `npm ci --ignore-scripts --dry-run` resolved successfully; full lockfile audit passed. This checkout lacks the starter's source and TypeScript configuration, so no starter build/test result is claimed.
