...
This folder stores the baseline technical decisions for SpainTrain.

## Records
1. [01-json-first-and-ingestion](01-json-first-and-ingestion.md)
2. [02-browser-only-topology](02-browser-only-topology.md)
...
- All records assume phase 1 has no custom backend.
- Any future override must create a new record and reference the superseded one.
